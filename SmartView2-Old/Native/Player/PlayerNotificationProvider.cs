...
namespace SmartView2.Native.Player
{
	public class PlayerNotificationProvider : IPlayerNotificationProvider
	{
		...
		public PlayerNotificationProvider(HwndSource source)
		{
			this.source = source;
			this.source.AddHook(new HwndSourceHook(this.HandleMessage));
			TimeSpan timeSpan = TimeSpan.FromSeconds(2);
			this.streamResolutionChangedTimer = new System.Timers.Timer(timeSpan.TotalMilliseconds)
			{
				AutoReset = true
			};
			this.streamResolutionChangedTimer.Elapsed += new ElapsedEventHandler(this.streamResolutionChangedTimer_Elapsed);
			TimeSpan timeSpan1 = TimeSpan.FromSeconds(2);
			this.streamAudioSampleRateTimer = new System.Timers.Timer(timeSpan1.TotalMilliseconds)
			{
				AutoReset = true
			};
			this.streamAudioSampleRateTimer.Elapsed += new ElapsedEventHandler(this.streamAudioSampleRateTimer_Elapsed);
			TimeSpan timeSpan2 = TimeSpan.FromSeconds(2);
			this.streamVersionChangedTimer = new System.Timers.Timer(timeSpan2.TotalMilliseconds)
			{
				AutoReset = true
			};
			this.streamVersionChangedTimer.Elapsed += new ElapsedEventHandler(this.streamVersionChangedTimer_Elapsed);
			TimeSpan timeSpan3 = TimeSpan.FromSeconds(2);
			this.streamPmtInfoChangedTimer = new System.Timers.Timer(timeSpan3.TotalMilliseconds)
			{
				AutoReset = true
			};
			this.streamPmtInfoChangedTimer.Elapsed += new ElapsedEventHandler(this.streamPmtInfoChangedTimer_Elapsed);
		...
		private IntPtr HandleMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled)
		{
			switch (msg)
			{
				case 1025:
				{
					Logger.Instance.LogErrorFormat(string.Format("STREAM_RESOLUTION_CHANGED - {0}", msg), new object[0]);
				...
				case 1026:
				{
					Logger.Instance.LogErrorFormat(string.Format("STREAM_AUDIO_SAMPLE_RATE_CHANGED - {0}", msg), new object[0]);
				...
				case 1027:
				{
					Logger.Instance.LogErrorFormat(string.Format("STREAM_VERSION_CHANGED - {0}", msg), new object[0]);
				...
				case 1028:
				{
					Logger.Instance.LogErrorFormat(string.Format("STREAM_PMT_INFO_CHANGED - {0}", msg), new object[0]);
				...
				case 1029:
				{
					switch ((int)wParam)
					{
						case 1:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_AUDIO_VIDEO - {0}", msg), new object[0]);
						...
						case 2:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_AUDIO_ONLY - {0}", msg), new object[0]);
						...
						case 3:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_NO_SIGNAL - {0}", msg), new object[0]);
						...
						case 4:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_LOCKED - {0}", msg), new object[0]);
						...
						case 5:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_SERVICE_NOT_AVAILABLE - {0}", msg), new object[0]);
						...
						case 6:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_3D_NOT_AVAILABLE - {0}", msg), new object[0]);
						...
						case 7:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_SCRAMBLED_CHANNEL - {0}", msg), new object[0]);
						...
						case 8:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_DATA_SERVICE - {0}", msg), new object[0]);
						...
						case 9:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_CHECK_CABLE - {0}", msg), new object[0]);
						...
						case 10:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_ADULT_SCENE_BLOCK - {0}", msg), new object[0]);
						...
						case 11:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_PARENTAL_LOCK - {0}", msg), new object[0]);
						...
						case 12:
						{
							Logger.Instance.LogErrorFormat(string.Format("STREAM_MEDIA_INVALID_NOT_AVAILABLE - {0}", msg), new object[0]);
				...
				case 1031:
				{
					...
					Logger.Instance.LogErrorFormat(string.Format("VIDEO_URL_RECEIVED: {0}", str), new object[0]);
					handled = true;
					break;
				}
				case 1032:
				{
					Logger.Instance.LogErrorFormat("VIDEO_INVALID_FORMAT", new object[0]);
					handled = true;
				...
				case 1033:
				{
					Logger.Instance.LogErrorFormat("VIDEO_PLAYBACK_STARTED", new object[0]);
					handled = true;
				...
				case 1034:
				{
					Logger.Instance.LogErrorFormat("VIDEO_PLAYBACK_STOPPED", new object[0]);
					handled = true;
				...
				case 1035:
				{
					Logger.Instance.LogErrorFormat("VIDEO_PLAYBACK_SHUTDOWN", new object[0]);
					handled = true;
				...
				case 1036:
				{
					Logger.Instance.LogErrorFormat("VIDEO_STREAM_EOS", new object[0]);
					handled = true;
					break;
				}
			}
